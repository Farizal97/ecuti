 ...
 <table class="table multimedia table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a class="btn simptip-position-left"  data-tooltip="Update User" href="#">
													<i class="icon-arrow-right"></i></a>
                                                    <a class="btn simptip-position-left" onclick="return deleteUser(<?php echo $row->id ?>)"><i class="icon-trash"></i></a>                                                </div>                                            </td>
                                        </tr>
