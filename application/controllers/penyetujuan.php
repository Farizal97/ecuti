...
class penyetujuan extends CI_Controller {
	...
	function index($limit='',$offset=''){
		...
		$config['base_url'] = base_url().'penyetujuan/search/';
		...
		$data['view']='penyetujuan/hist_cuti';
	...
	function search($limit='',$offset=''){
		...
		$data['query']=$this->cuti_model->getListCuti($limit,$offset);
		$this->load->view('penyetujuan/data_cuti',$data);
	}
	...
	function addForm(){
		...
		$this->load->view('penyetujuan/form',$data);
	}
